...
export default function Page() {
  return (
    <AdminShell>
      ...
      <h1 className="mt-2 text-4xl font-black text-slate-950">Payments Overview</h1>
      <p className="mt-2 max-w-3xl text-slate-600">Monitor payments, invoices, refunds, failed transactions, and subscription billing.</p>
