...
export default function Page() {
  return (
    <AdminShell>
      ...
      <h1 className="mt-2 text-4xl font-black text-slate-950">Orders Overview</h1>
      <p className="mt-2 max-w-3xl text-slate-600">Track platform orders, status, transactions, and fulfillment signals.</p>
